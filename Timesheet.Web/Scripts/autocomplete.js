...
(function ($) {
    var Autocomplete = function () {
        function Autocomplete(element, options) {
            ...
            this.$container.append('<span class="input-group-btn">' + '<button class="btn-default" style="border: 1px solid #dcd9d9;padding: 6px 12px; font-size: 14px; border-bottom-right-radius: 4px; border-top-right-radius: 4px; background-color: gainsboro;" type="button" tabindex="-1">' + '</button></span>');
